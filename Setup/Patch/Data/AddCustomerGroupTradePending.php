 ...
 */
class AddCustomerGroupTradePending implements DataPatchInterface, PatchVersionInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $this->moduleDataSetup->getConnection()->insertForce(
            ...
            ['customer_group_id' => 5, 'customer_group_code' => 'TradePending', 'tax_class_id' => 3]
        );
